            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <select name="clazz" class="form-control input-lg dynamic" data-dependent="student">
                        ...
                        <?php $__currentLoopData = $classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($lga->id); ?>"><?php echo e($lga->title); ?></option>
                ...
                <form action="<?php echo e(route('admin.promotion.store')); ?>" method="POST" class="form" id="form">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label">Class</label>
                            <select name="classs" class="form-control input-lg dynamic" required>
                                <option value="">Select Class</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Project/DataStamp-LURITS_QA/resources/views/admin/studentAdmissions/promotion-create.blade.php ENDPATH**/ ?>