            ...
            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input class="form-control" type="text" id="staff_id" value="<?php echo e($staff->lga_staff_id ?? ''); ?>" readonly>
                        <?php if($errors->has('')): ?>
                            <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                        <?php endif; ?>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label class="required" for="address"><?php echo e(trans('cruds.studentAdmission.fields.address')); ?><?php echo e("*"); ?></label>
