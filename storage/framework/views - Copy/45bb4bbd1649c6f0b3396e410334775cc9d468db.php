...
<div class="card">
    ...
    <div class="card-body">
      <form action="<?php echo e(route('admin.att.get.save')); ?>" method="POST" autocomplete="off">
        <?php echo csrf_field(); ?>
        <div class="row">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Project/DataStamp-LURITS_QA/resources/views/admin/attendances/index.blade.php ENDPATH**/ ?>