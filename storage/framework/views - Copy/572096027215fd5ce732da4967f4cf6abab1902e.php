                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 err">
                                <select class="form-control" name="rate" id="rate">
                                    ...
                                    <option value="extreme" <?php echo e(old('rate') === 'extreme' ? 'selected' : null); ?>>
                                        Extreme
                                    </option>
                                    <option value="high" <?php echo e(old('rate') === 'high' ? 'selected' : null); ?>>High
                                    </option>
                                    <option value="medium" <?php echo e(old('rate') === 'medium' ? 'selected' : null); ?>>
                                        Medium
                                    </option>
                                    <option value="low" <?php echo e(old('rate') === 'low' ? 'selected' : null); ?>>Low</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        ...
        var table = $('#dataTable').DataTable({
            ...
            pageLength: 100,
            ajax: {
                url: "<?php echo e(route('admin.incidences.index')); ?>",
            },
            columns: [
        ...
        $('body').on('click', '.viewIncidence', function () {
            ...
            $('#image_div').empty();
             $.get("<?php echo e(url('admin/incidences')); ?>" + '/' + incidence_id, function (data) {
        ...
        $('body').on('click', '.editIncidence', function () {
            var incidence_id = $(this).data('id');
             $.get("<?php echo e(url('admin/incidences')); ?>" + '/' + incidence_id + '/edit', function (data) {
        ...
        $('#incidenceForm').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/incidences')); ?>",
                    type: "POST",
                    data: formdata,
                    contentType: false,
                    cache: false,
...
<script>
  ...
  $(function () {
    // datatable
    var school = <?php echo Auth::User()->school_id; ?>;
    // alert(school);
    var table = $('#dataTable').DataTable({
        processing: true,
        serverSide: true,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/admin/pages/incidencereporting/manageincidence.blade.php ENDPATH**/ ?>