    ...
    <div class="col-6 table-responsive">
        <table class="table table-striped">
            <tbody>
                <tr>
                    <th style="width:40%">LGEA:</th>
                    <td id="lgaName" value="<?php echo e($lgaName  ?? '#'); ?>"><?php echo e($lgaName); ?></td>
                </tr>
                <tr>
        ...
        <table class="table table-striped">
            <tbody>
                <tr>
                    ...
                    <td id="teachers" value="<?php echo e($teachers->count()); ?>"><?php echo e($teachers->count()); ?></td>
                </tr>
                <tr>
                    <th style="width:60%">Total Student Enrolment:</th>
                    <td id="students" value="<?php echo e($students->count()); ?>"><?php echo e($students->count()); ?></td>
                </tr>
            </tbody>
        </table>
     </div>
