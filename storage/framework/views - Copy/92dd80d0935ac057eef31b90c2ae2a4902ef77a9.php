    ...
    <script type="text/javascript">
                $(function () {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "<?php echo e(route('admin.calls.index')); ?>",
                        columns: [
                    ...
                    $('#saveBtn').click(function (e) {
                        ...
                        $.ajax({
                            enctype: 'multipart/form-data',
                            data: formdata,
                            url: "<?php echo e(url('admin/calls')); ?>",
                            type: "POST",
                            processData: false,
                            contentType: false,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/admin/pages/managecalls.blade.php ENDPATH**/ ?>