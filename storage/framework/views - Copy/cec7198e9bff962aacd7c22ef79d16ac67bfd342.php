                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-12 err">
                                        <select class="form-control" name="teacher" id="teacher" required>
                                            ...
                                            <option value="<?php echo e($teacher->id); ?>"><?php echo e($teacher->first_name); ?> <?php echo e($teacher->middle_name); ?> <?php echo e($teacher->last_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
        ...
        $(function () {
         ...
         $('#start_time').datetimepicker({
            ...
            $('body').on('change', '#class', function () {
                ...
                $('#spinner').show();
                $.ajax({
                    url: '<?php echo e(route("admin.subjects.filter")); ?>',
            ...
            var table = $('#dataTable').DataTable({
                ...
                ajax: "<?php echo e(url('admin/classschedules')); ?>",
                columns: [
            ...
            $('#classscheduleForm').validate({
                ...
                submitHandler: function (form) {
                    $.ajax({
                        ...
                        url: "<?php echo e(url('admin/classschedules')); ?>",
                        type: "POST",
                        dataType: 'json',
                        beforeSend: function () {
                            $('.alert-danger').html('');
            ...
            $('body').on('click', '.editSchedule', function () {
                var classschedule_id = $(this).data('id');
                 $.get("<?php echo e(url('admin/classschedules')); ?>" + '/' + classschedule_id + '/edit', function (data) {
            ...
            $('body').on('click', '.viewSchedule', function () {
                ...
                $.get("<?php echo e(url('admin/classschedules')); ?>" + '/' + class_schedule_id + '/edit', function (data) {
                    $('#saveBtn').html('Print');
            ...
            $('body').on('click', '.deleteSchedule', function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: "<?php echo e(url('admin/classschedules')); ?>" + '/' + classschedule_id,
                            beforeSend: function () {
                                $('.alert-danger').html('');
                                $('.alert-danger').hide();
                                $('#spiner').html('<div class="overlay d-flex justify-content-center align-items-center">\n' +
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Project/DataStamp-LURITS_QA/resources/views/admin/pages/lessonmanagement/manageclassschedules.blade.php ENDPATH**/ ?>