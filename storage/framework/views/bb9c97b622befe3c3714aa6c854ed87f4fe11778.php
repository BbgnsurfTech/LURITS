        ...
        <div class="tab-content mt-4">
            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input class="form-control" type="text" id="lga_staff_id" value="<?php echo e($staff->lga_staff_id ?? ''); ?>" readonly>
                        <?php if($errors->has('')): ?>
                            <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                        <?php endif; ?>
            ...
            <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label class="required" for="grade_step"><?php echo e('Grade Step'); ?></label>
                        <input class="form-control <?php echo e($errors->has('grade_step') ? 'is-invalid' : ''); ?>" type="text" name="grade_step" id="grade_step" value="<?php echo e(old('grade_step', $staff->grade_step)); ?>">
                        <?php if($errors->has('')): ?>
                            <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                        <?php endif; ?>                
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/admin/staffs/edit.blade.php ENDPATH**/ ?>