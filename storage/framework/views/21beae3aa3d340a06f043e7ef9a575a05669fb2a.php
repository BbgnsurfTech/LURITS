                    ...
                    <div class="modal-content">
                      <div class="modal-body">
                        <div class="close-btn">
                          ...
                          <form class="new-added-form" method="POST" action="<?php echo e(route("admin.income-categories.store")); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-IncomeCategory" style="width: 100%">
                <thead>
                    <tr>
                        <th width="10">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/admin/incomeCategories/index.blade.php ENDPATH**/ ?>