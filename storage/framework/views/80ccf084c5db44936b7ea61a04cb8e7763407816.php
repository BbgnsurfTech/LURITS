        ...
        <div class="tab-content mt-4">
            ...
            <?php if(Auth::User()->is_headTeacher): ?>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="form-control <?php echo e($errors->has('parental_status') ? 'is-invalid' : ''); ?>" name="parental_status" id="parental_status" data-dependent="lga_origin" required>
                        <option value disabled><?php echo e(trans('global.pleaseSelect')); ?></option>
                        <?php $__currentLoopData = $parental_statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $parental_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e((old('parental_status', 0) == $id || isset($studentAdmission) && $studentAdmission->parental_status_id == $id) ? 'selected' : ''); ?>><?php echo e($parental_status); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($errors->has('')): ?>
                        <span class="text-danger"><?php echo e($errors->first('')); ?></span>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                   <label class="required">Date of Admission*</label>
                    <input name="date_of_admission" id="date_of_admission" value="<?php echo e(old('date_of_admission', date('Y/m/d', strtotime($studentAdmission->date_of_admission)) )); ?>" type="text" placeholder="yyyy/mm/dd" data-date-format="yyyy/mm/dd" class="form-control air-datepicker" data-position='bottom right' autocomplete="off" required>
                    <i class="far fa-calendar-alt"></i>
                    <?php if($errors->has('')): ?>
                        <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                    <?php endif; ?>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="form-control <?php echo e($errors->has('blood_group') ? 'is-invalid' : ''); ?>" name="blood_group" id="blood_group">
                        <option value disabled <?php echo e((old('blood_group', null) || isset($studentAdmission) && $studentAdmission->blood_group_id == null) ? 'selected' : ''); ?>><?php echo e(trans('global.pleaseSelect')); ?></option>
                        <?php $__currentLoopData = $blood_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e((old('blood_group', 0) == $id || isset($studentAdmission) && $studentAdmission->blood_group_id == $id) ? 'selected' : ''); ?>><?php echo e($categories); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($errors->has('')): ?>
                        <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="form-control <?php echo e($errors->has('marital_status') ? 'is-invalid' : ''); ?>" name="marital_status" id="marital_status" required>
                        <option value disabled <?php echo e((old('maritalstatus', null) || isset($studentAdmission) && $studentAdmission->marital_status_id == null) ? 'selected' : ''); ?>><?php echo e(trans('global.pleaseSelect')); ?></option>
                        <?php $__currentLoopData = $marital_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e((old('marital_status', 0) == $id || isset($studentAdmission) && $studentAdmission->marital_status_id == $id) ? 'selected' : ''); ?>><?php echo e($categories); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($errors->has('')): ?>
                        <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="form-control <?php echo e($errors->has('disability') ? 'is-invalid' : ''); ?>" name="disability" id="disability" data-dependent="lga_origin" required>
                        <option value disabled <?php echo e((old('disability', null) || isset($studentAdmission) && $studentAdmission->disability == null) ? 'selected' : ''); ?>><?php echo e(trans('global.pleaseSelect')); ?></option>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="form-control <?php echo e($errors->has('state_origin') ? 'is-invalid' : ''); ?>" name="state_origin" id="state_origin" data-dependent="lga_origin" required>
                        <option value="<?php echo e($studentAdmission->state_origin? $studentAdmission->state_origin->code_atlas_entity :""); ?>"><?php echo e($studentAdmission->state_origin? $studentAdmission->state_origin->name_atlas_entity : ""); ?></option><hr>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select name="lga_origin" class="form-control input-lg dynamic" id="lga_origin" required>
                        <option value="<?php echo e($studentAdmission->lga_origin ? $studentAdmission->lga_origin->code_atlas_entity :""); ?>"><?php echo e($studentAdmission->lga_origin? $studentAdmission->lga_origin->name_atlas_entity :""); ?></option>
                    </select>
                    <?php if($errors->has('')): ?>
                        <span class="text-danger"><?php echo e($errors->first('')); ?></span>
                    <?php endif; ?>    
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="form-control <?php echo e($errors->has('eccd') ? 'is-invalid' : ''); ?>" name="eccd" id="eccd" required>
                        ...
                        <?php $__currentLoopData = $ds_yes_no; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $yes_no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e((old('eccd', 0) == $id || isset($studentAdmission) && $studentAdmission->eccd == $id) ? 'selected' : ''); ?>><?php echo e($yes_no->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($errors->has('')): ?>
                        <span class="text-danger"><?php echo e($errors->first('')); ?></span>
