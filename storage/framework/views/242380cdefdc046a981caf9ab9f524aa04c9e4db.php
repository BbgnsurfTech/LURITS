            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select name="last_class_attended" class="form-control input-lg dynamic" id="last_class_attended">
                        ...
                        <?php $__currentLoopData = $sector_classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $last_class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($last_class->dsClass[0]->id); ?>"><?php echo e($last_class->dsClass[0]->title); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/admin/transfer/create.blade.php ENDPATH**/ ?>