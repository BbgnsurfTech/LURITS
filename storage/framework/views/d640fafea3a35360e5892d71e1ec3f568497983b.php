       ...
       <div class="mobile-sidebar-header d-md-none">
        ...
        <div class="sidebar-menu-content">
            <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('school_management_access')): ?>
                    <li class="nav-item sidebar-nav-item ">
                        ...
                        <ul class="nav sub-group-menu">
                            ...
                            <?php endif; ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route("admin.textbooks.index")); ?>" class="nav-link <?php echo e(request()->is('admin/textbooks') || request()->is('admin/textbooks/*') ? 'active' : ''); ?>">
                                    <i class=" fas fa-list"></i>
                                    <span>Textbooks</span>
                                </a>
                            </li>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('classroom_access')): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route("admin.seatings.index")); ?>" class="nav-link <?php echo e(request()->is('admin/seatings') || request()->is('admin/seatings/*') ? 'active' : ''); ?>">
                                        <i class=" fas fa-list"></i>
                                        <span>Class Seating</span>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('toilet_access')): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route("admin.toilets.index")); ?>" class="nav-link ">
                                        <i class=" fas fa-list"></i>
                                        <span>Toilets</span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item sidebar-nav-item ">
                        ...
                        <ul class="nav sub-group-menu">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('schedule_classes_access')): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route("admin.classschedules.index")); ?>" class="nav-link <?php echo e(request()->is('admin/classschedules') || request()->is('admin/classschedules/*') ? 'active' : ''); ?>">
                                        <i class=" fas fa-list"></i>
                                        <span>Schedule Classes</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route("admin.lesson.attendance")); ?>" class="nav-link ">
                                        <i class=" fas fa-list"></i>
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('incidence_reporting_access')): ?>
                <li class="nav-item sidebar-nav">
                    <a href="<?php echo e(route("admin.incidences.index")); ?>" class="nav-link ">
                        <i class="flaticon-books"></i>
                        <span>Incidence Reporting</span>
                    </a>
                </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('parent_guardianregister_access')): ?>
                <li class="nav-item sidebar-nav">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact_management_access')): ?>
                    <li class="nav-item sidebar-nav-item ">
                        ...
                        <ul class="nav sub-group-menu">
                            <li class="nav-item">
                                <a href="<?php echo e(route("admin.calls.index")); ?>" class="nav-link ">
                                    <i class=" fas fa-list"></i>
                                    <span>Call</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route("admin.voicecalls.index")); ?>" class="nav-link ">
                                    <i class=" fas fa-list"></i>
                                    <span>Voice Call</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin/messenger')); ?>" class="nav-link ">
                                    <i class=" fas fa-list"></i>
                                    <span>Send Internal Mail</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin/mailsms')); ?>" class="nav-link ">
                                    <i class=" fas fa-list"></i>
                                    <span>Send Email/SMS</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin/calltemplates')); ?>" class="nav-link ">
                                    <i class=" fas fa-list"></i>
                                    <span>Voice Call Templates</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin/mailsmstemplates')); ?>" class="nav-link ">
                                    <i class=" fas fa-list"></i>
...
</div><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/partials/menu.blade.php ENDPATH**/ ?>