...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('classroom_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.classrooms.massDestroy')); ?>",
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    ajax: {
        url: "<?php echo e(route('admin.classrooms.getClassrooms')); ?>",
    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bbgnsurf\PhpStom Project\LURITS\DataStamp-LURITS_QA_v1.1\resources\views/admin/classroom/index.blade.php ENDPATH**/ ?>