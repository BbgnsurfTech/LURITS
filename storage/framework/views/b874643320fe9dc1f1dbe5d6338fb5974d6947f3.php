        ...
        <div class="row">
            <div class="col-md-4">
                <div class="item-img ml-5">
                    <img src="<?php if($studentAdmission->student_picture): ?> <?php echo e($studentAdmission->student_picture->getUrl()); ?> <?php else: ?> <?php echo e(asset('img/classmates.png')); ?> <?php endif; ?>" width="100px" height="100px" style="border-radius: 50%;" alt="Student image">
                </div>     
            </div>
            <div class="col-md-4">
...
<div class="card height-auto">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-4">
                <div class="item-img ml-5">
                    <img src="<?php if($studentAdmission->parent_guardian): ?><?php if($studentAdmission->parent_guardian->photo): ?> <?php echo e(config('app.url')); ?>/storage/images/parents/<?php echo e($studentAdmission->parent_guardian->photo); ?> <?php else: ?> <?php echo e(asset('img/parents.png')); ?> <?php endif; ?> <?php else: ?> <?php echo e(asset('img/parents.png')); ?> <?php endif; ?>" width="100px" height="100px" style="border-radius: 50%;" alt="Parent image">
                </div>     
            </div>
            <div class="col-md-8">
