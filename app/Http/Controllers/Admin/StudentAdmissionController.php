...
class StudentAdmissionController extends Controller
{
    ...
    public function create()
    {
        ...
        $parent_guardians = ParentGuardianregister::all()->pluck('first_name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.studentAdmissions.create', compact('school_enrolleds', 'parent_guardians'));
    }
    ...
    public function edit(StudentAdmission $studentAdmission)
    {
        ...
        $studentAdmission->load('school_enrolled', 'parent_guardian', 'team');

        return view('admin.studentAdmissions.edit', compact('school_enrolleds', 'parent_guardians', 'studentAdmission'));
    }
    ...
    public function show(StudentAdmission $studentAdmission)
    {
        ...
        $studentAdmission->load('school_enrolled', 'parent_guardian', 'team', 'admissionAttendances');
