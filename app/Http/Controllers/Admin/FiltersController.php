...
{
    public function fetchSectorClasses(School $school)
    {
    ...
    public function fetchLgas($state)
    {
        ...
        $lga = Atlas::whereIn('code_atlas_entity', $stateLGA)->where('code_ds_atlas_entity', 3)->pluck('name_atlas_entity', 'code_atlas_entity');
    ...
    public function fetchStates($country)
    {
        ...
        $state = Atlas::whereIn('code_atlas_entity', $countryState)->pluck('name_atlas_entity','code_atlas_entity');
        //dd($state);
