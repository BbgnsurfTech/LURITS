...
//        dd(Request::segments());
        ...
        return view('admin.pages.mailbox.index', compact('folders', 'messages', 'unreadMessages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.pages.mailbox.compose', compact('folders', 'unreadMessages', 'users'));
    }
...
//        $folder = $mailbox->userFolder()->folder()->first();
        ...
        return view('admin.pages.mailbox.show', compact('folders', 'unreadMessages', 'mailbox'));
    }
    ...
    public function getReply($id)
    {
        ...
        return view('admin.pages.mailbox.reply', compact('folders', 'unreadMessages', 'mailbox'));
    }
    ...
    public function getForward($id)
    {
        ...
        return view('admin.pages.mailbox.forward', compact('folders', 'unreadMessages', 'mailbox', 'users'));
    }
