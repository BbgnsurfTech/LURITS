    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teachers.update", [$teacher->id]) }}" enctype="multipart/form-data">
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <input class="form-control {{ $errors->has('staff_file_number') ? 'is-invalid' : '' }}" type="text" name="staff_file_number" id="staff_file_number" value="{{ old('staff_file_number', $teacher->staff_file_number) }}" required>
                @if($errors->has(''))
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
               <label class="required">Date of Birth</label>
                <input name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $teacher->date_of_birth) }}" type="text" placeholder="yyyy/mm/dd" data-date-format="yyyy/mm/dd" class="form-control air-datepicker" data-position='bottom right' autocomplete="off">
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <input class="form-control {{ $errors->has('first_appointment') ? 'is-invalid' : '' }}" type="text" name="first_appointment" id="first_appointment" value="{{ old('first_appointment', $teacher->first_appointment) }}" required>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif                
            </div>
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <input class="form-control {{ $errors->has('present_appointment') ? 'is-invalid' : '' }}" type="text" name="present_appointment" id="present_appointment" value="{{ old('present_appointment', $teacher->present_appointment) }}" required>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif                
            </div>
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <input class="form-control {{ $errors->has('posting_to_school') ? 'is-invalid' : '' }}" type="text" name="posting_to_school" id="posting_to_school" value="{{ old('posting_to_school', $teacher->posting_to_school) }}" required>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif                
            </div>
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <input class="form-control {{ $errors->has('grade_step') ? 'is-invalid' : '' }}" type="text" name="grade_step" id="grade_step" value="{{ old('grade_step', $teacher->grade_step) }}" placeholder="e.g 7/2" required>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif                
            </div>
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                    ...
                    @foreach(App\Teacher::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $teacher->gender, '255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('type_of_staff') ? 'is-invalid' : '' }}" name="type_of_staff" id="type_of_staff" required>
                    ...
                    @foreach(App\Teacher::TYPE_OF_STAFF as $key => $label)
                        <option value="{{ $key }}" {{ old('type_of_staff', $teacher->type_of_staff ,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('source_of_salary') ? 'is-invalid' : '' }}" name="source_of_salary" id="source_of_salary" required>
                    ...
                    @foreach(App\Teacher::SOURCE_OF_SALARY as $key => $label)
                        <option value="{{ $key }}" {{ old('source_of_salary', $teacher->source_of_salary,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('present') ? 'is-invalid' : '' }}" name="present" id="present" required>
                    ...
                    @foreach(App\Teacher::PRESENT as $key => $label)
                        <option value="{{ $key }}" {{ old('present', $teacher->present ,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('academic_qualification') ? 'is-invalid' : '' }}" name="academic_qualification" id="academic_qualification" required>
                    ...
                    @foreach(App\Teacher::ACADEMIC_QUALIFICATION as $key => $label)
                        <option value="{{ $key }}" {{ old('academic_qualification', $teacher->academic_qualification,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('teaching_qualification') ? 'is-invalid' : '' }}" name="teaching_qualification" id="teaching_qualification" required>
                    ...
                    @foreach(App\Teacher::TEACHING_QUALIFICATION as $key => $label)
                        <option value="{{ $key }}" {{ old('teaching_qualification', $teacher->teaching_qualification,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                <label class="required" for="area_of_specialization">Subject of Qualification</label>
                <select class="form-control select2 {{ $errors->has('area_of_specialization') ? 'is-invalid' : '' }}" name="area_of_specialization" id="area_of_specialization">
                    ...
                    @foreach($subjects as $subject)
                        <option value="{{ $subject->id }}" {{ old('area_of_specialization', $teacher->area_of_specialization) == $subject->id ? 'selected' : '' }}>{{ $subject->ds_subject_name }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('teaching_type') ? 'is-invalid' : '' }}" name="teaching_type" id="teaching_type" required>
                    ...
                    @foreach(App\Teacher::TEACHING_TYPE as $key => $label)
                        <option value="{{ $key }}" {{ old('teaching_type', $teacher->teaching_type ,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control select2 {{ $errors->has('subject_of_qualification') ? 'is-invalid' : '' }}" name="subject_of_qualification" id="subject_of_qualification">
                    <option id="none" name="none" value="0" {{ old('none') }}>None</option>
                    @foreach($subjects as $subject)
                        <option value="{{ $subject->id }}" {{ old('subject_of_qualification', $teacher->subject_of_qualification) == $subject->id ? 'selected' : '' }}>{{ $subject->ds_subject_name }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control select2 {{ $errors->has('subject_taught') ? 'is-invalid' : '' }}" name="subject_taught" id="subject_taught">
                    <option id="none" name="none" value="0" {{ old('none') }}>None</option>
                    @foreach($subjects as $subject)
                        <option value="{{ $subject->id }}" {{ old('subject_taught', $teacher->subject_taught) == $subject->id ? 'selected' : '' }}>{{ $subject->ds_subject_name }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="form-control {{ $errors->has('seminar_workshop') ? 'is-invalid' : '' }}" name="seminar_workshop" id="seminar_workshop" required>
                    ...
                    @foreach(App\Teacher::SEMINAR_WORKSHOP as $key => $label)
                        <option value="{{ $key }}" {{ old('seminar_workshop', $teacher->seminar_workshop ,'255') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
