    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expenses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('issued_cheque_no') ? 'is-invalid' : '' }}" type="text" name="issued_cheque_no" id="issued_cheque_no" value="{{ old('issued_cheque_no', '') }}">
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.expense.fields.description_helper') }}</span>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balance_as_at') ? 'is-invalid' : '' }}" type="text" name="balance_as_at" id="balance_as_at" value="{{ old('balance_as_at', '') }}">
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.expense.fields.description_helper') }}</span>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_of_authorizing_individual') ? 'is-invalid' : '' }}" type="text" name="name_of_authorizing_individual" id="name_of_authorizing_individual" value="{{ old('name_of_authorizing_individual', '') }}">
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.expense.fields.description_helper') }}</span>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('funds_out') ? 'is-invalid' : '' }}" type="text" name="funds_out" id="funds_out" value="{{ old('funds_out', '') }}">
                @if($errors->has(''))
                    <span class="text-danger">{{ $errors->first('') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.expense.fields.description_helper') }}</span>
