                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-6">                                
                                    ...
                                    <img id="modal-preview" src="{{asset('uploads/avatar.jpg')}}" alt="Preview"
    ...
    $(function () { 
        ...
        $.ajaxSetup({
         ...
         var table = $('#dataTable').DataTable({
                    ...
                    ajax: { url:"{{ route('admin.parents.index') }}"},
        ...
        $('body').on('click', '.editParent', function () {
            var parent_id = $(this).data('id');
             $.get("{{ url('admin/parents') }}" + '/' + parent_id + '/edit', function (data) {
        ...
        $('body').on('click', '.viewParent', function () {
            var parentID = $(this).data('id');
             $.get("{{ url('admin/parents') }}" + '/' + parentID, function (data) {
            ...
            var parentID = $(this).data('id');
             ...
             $.get("{{ url('admin/parents') }}" + '/' + parentID, function (data) {
                ...
                if (result.value) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ url('admin/parents') }}" + '/' + parent_id,
                        success: function (data) {
                            Swal.fire({
                                title: 'Deleted!',
